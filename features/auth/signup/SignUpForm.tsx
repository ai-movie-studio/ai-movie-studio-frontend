...
import { signUpSchema } from "@/components/schema/auth_schema"
import { SignUpTypes } from "@/lib/types"
    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className={cn(
            "w-full bg-white/95 backdrop-blur-xl shadow-2xl overflow-hidden border border-white/20 z-30 transition-all duration-300 my-8",
        ...
        >
          <div className={cn(
            ...
            <div className="mb-10">
              ...
              <p className="text-gray-500 mt-2">Join Nabula and start your journey</p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              <Button
                disabled={isLoading}
                type="submit"
                className="w-full h-14 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-lg font-semibold transition-all shadow-lg shadow-blue-500/25 active:scale-[0.98] mt-4"
              >
